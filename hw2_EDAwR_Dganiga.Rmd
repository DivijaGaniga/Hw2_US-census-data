...
Eachh row represents demographic, social, economic and commuting factors of each County in United states and Michigan respectively.
...
g + geom_histogram(mapping = aes(x = Income), binwidth = 5000, fill = "#FF00CC")+
 ...
 g+ geom_violin(aes(x="Label", y= Income), 
...
#log_totalpop <- log(county_df$TotalPop)
g + geom_histogram(mapping = aes(x = TotalPop))
...
g + geom_histogram(mapping = aes(x = TotalPop), fill = "#FF9999")+ggtitle("Distribution of population for US counties")+ylab("Number of counties")+xlab("Total Population")
...
-Weather conditions and population density might be the reason why income distribution and Median income in UP is less than Lower Peninsula

```{r vp_inc_by_peninsula}

ggplot(data = county_MI)+ geom_violin(aes(x=peninsula, y=Income, fill = peninsula))+ ggtitle("Median income distribution based on peninsula in MI")+
                          xlab(" Peninsula in MI") + ylab("Median income")+theme(axis.title.x = element_text(face="bold", colour="#990000", size=20),
           axis.text.x  = element_text(vjust=0.5, size=12)) +theme(axis.title.y = element_text(face="bold", colour="#990000", size=20))
...
ggplot(data = county_df, aes(x = Unemployment, fill = Region)) +
  ...
  facet_wrap(~ Region) +
  guides(fill = FALSE) + ggtitle("Unemployement rate in US by region")+theme(axis.title.x = element_text(face="bold", colour="#990000", size=15),
...
# from the website https://drsimonj.svbtle.com/plotting-background-data-for-groups-with-ggplot2
...
ggplot(data = county_df, aes(x= "",y = MeanCommute, fill = Region)) +
  ...
  facet_wrap(~ Region) +
  guides(fill = FALSE) + ggtitle("Mean commute time in US by region")+theme(axis.title.x = element_text(face="bold", colour="#990000", size=15),
           axis.text.x  = element_text(vjust=0.5, size=10)) +theme(axis.title.y = element_text(face="bold", colour="#990000", 
...
```{r bar_counties_by_division}
  ...
  axis.text.x  = element_text(angle = 90,vjust=0.5, size=10))+ ggtitle("Number of counties in each Division of US")+ylab("Number of Counties")+
...
ggplot(data = county_MI, aes(x= Employed, y = Income ))+geom_point(aes(colour = Employed))+facet_wrap(~peninsula)+ ggtitle("Scatterplot of income vs employed")+scale_color_gradient(low = "red", high = "blue")+xlab("Number of people employed")


# distribution of income of private workers 

ggplot(data = county_MI, aes(x= PrivateWork, y = Income ))+geom_point(aes(colour = Income))+facet_wrap(~peninsula)+ ggtitle("Scatterplot of income of Private employed")+scale_color_gradient(low = "red", high = "blue")+xlab("Percentage of Private employed population")

# distribution of income of Public workers
ggplot(data = county_MI, aes(x= PublicWork, y = Income ))+geom_point(aes(colour = Income))+facet_wrap(~peninsula)+ ggtitle("Scatterplot of income of Public employed")+scale_color_gradient(low = "red", high = "blue")+xlab("Percentage of Public employed population")
...
# Total Pop vs Poverty
ggplot(data = county_MI, aes(x= TotalPop, y = Poverty ))+geom_point(aes(colour = Poverty))+facet_wrap(~peninsula)+ ggtitle("Scatterplot of TotalPop vs Poverty")+scale_color_gradient(low = "red", high = "blue") +xlab("Total Population")
